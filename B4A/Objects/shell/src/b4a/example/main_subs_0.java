...
b4xtrabajos.myClass = BA.getDeviceClass ("b4a.example.b4xtrabajos");
b4xclientes.myClass = BA.getDeviceClass ("b4a.example.b4xclientes");
starter.myClass = BA.getDeviceClass ("b4a.example.starter");
trabajo.myClass = BA.getDeviceClass ("b4a.example.trabajo");
trabajos.myClass = BA.getDeviceClass ("b4a.example.trabajos");
cliente.myClass = BA.getDeviceClass ("b4a.example.cliente");
clientes.myClass = BA.getDeviceClass ("b4a.example.clientes");
